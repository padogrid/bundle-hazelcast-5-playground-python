# %%
"""
DacReplicatedMap provides a blotter for viewing ReplicatedMap contents.
"""
...
class DacReplicatedMap(DacBase, Viewer):
    
    ds_type = 'ReplicatedMap'
    ...
    def __init__(self, **params):
        ...
        map_list = []
        self._map_select = pn.widgets.Select(name='ReplicatedMap', sizing_mode='fixed', options=map_list)
